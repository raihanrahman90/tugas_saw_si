...
?>
       <main class="content">
              ...
              <form action="../action/addKriteria.php" id="my_form" method="post" onsubmit="return validasi();">
                <table class="table" id="" width="100%" cellspacing="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <div class="col-lg-6">
                      <td><input type="text" class="form-control" name="kode" required></td></div>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><label>:</label></td></div>
                      <div class="col-lg-6">
                      <td><input type="text" class="form-control" name="kriteria" id="kriteria"required></td></div>
                    </tr>
                    <tr>
                      <div class="row">
                      <div class="col-lg-3">
